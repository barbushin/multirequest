...
class Request
{
    ...
    protected function hasHeadersBug()
    {
        $curlVersion = curl_version();
        return version_compare($curlVersion['version'], '7.30', '<');
    }
    ...
    public function handleCurlResult()
    {
        ...
        if (!$this->hasHeadersBug() || is_null($contentLength) || $contentLength == 0) {
        ...
        $this->callbacks->onHandleCurlResult($this, $responseData);
    ...
    public function onHandleCurlResult($callback)
    {
        $this->callbacks->add(__FUNCTION__, $callback);
        return $this;
    }
